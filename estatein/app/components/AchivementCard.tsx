...
export default function AchivementCard({
    ...
    return(
        <div className="w-full flex flex-col gap-4 p-7.5 bg-grey-08 border border-grey-15 shadow-[0_0_0_0.25rem] shadow-[#191919] rounded-[0.625rem] lg:rounded-xl lg:p-12.5 lg:shadow-[0_0_0_0.5rem]">
